...
#define I_DIAG_PIN                          PG11  // Z2-STOP //GA3Dtech I à la place de Z2
...
//GA3D I axis
  ...
  #if I_HOME_TO_MIN
    #define I_MAX_PIN                E3_DIAG_PIN  // PWRDET
  #else
    #define I_MIN_PIN                E3_DIAG_PIN  // PWRDET
  #endif
#elif NEEDS_I_MINMAX
  #ifndef I_MIN_PIN
...
#undef NEEDS_I_MINMAX //GA3D I axis
