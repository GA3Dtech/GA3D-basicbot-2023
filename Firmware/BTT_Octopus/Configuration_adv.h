...
#define SENSORLESS_BACKOFF_MM  { 2, 2, 0 ,0  }   //GA3Dtech // (linear=mm, rotational=°) Backoff from endstops before sensorless homing

#define HOMING_BUMP_MM      { 0, 0, 2 ,0 }  //GA3Dtech     // (linear=mm, rotational=°) Backoff from endstops after first bump
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 500  //GA3Dtech
  ...
  #define BLTOUCH_FORCE_SW_MODE  //GA3Dtech
...
#define AXIS_RELATIVE_MODES { false, false, false, false, false }  //GA3Dtech 
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 2*60 , 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel  //GA3D
...
// LCD Print Progress options
  ...
  #define LONG_FILENAME_HOST_SUPPORT    //GA3Dtech // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol

  #define SCROLL_LONG_FILENAMES      //GA3Dtech   // Scroll long filenames in the SD card menu
 ...
 */
#define LIN_ADVANCE  //GA3D
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0.22    // Unit: mm compression per 1mm/s extruder speed
  //#define LA_DEBUG            // If enabled, this will generate debug information output over USB.
  #define EXPERIMENTAL_SCURVE // Enable this option to permit S-Curve Acceleration  //GA3Dtech
 ...
 */
#define G29_RETRY_AND_RECOVER //GA3Dtech
 ...
 */
#define ADVANCED_PAUSE_FEATURE //GA3Dtech
 ...
 */
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       1500    //GA3dtech due to double motor on same driver
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V  //GA3Dtech        // All axes (override below)
   ...
   */
  #define MONITOR_DRIVER_STATUS  //GA3Dtech
   ...
   */
  #define SENSORLESS_HOMING   //GA3Dtech // StallGuard capable drivers only

  #if EITHER(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  50 //GA3Dtech
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  50  //GA3Dtech
    #define Y2_STALL_SENSITIVITY Y_STALL_SENSITIVITY
    //#define Z_STALL_SENSITIVITY  8
    //#define Z2_STALL_SENSITIVITY Z_STALL_SENSITIVITY
    //#define Z3_STALL_SENSITIVITY Z_STALL_SENSITIVITY
    //#define Z4_STALL_SENSITIVITY Z_STALL_SENSITIVITY
    #define I_STALL_SENSITIVITY  50 //GA3Dtech
    ...
    #define IMPROVE_HOMING_RELIABILITY //GA3Dtech
  #endif
   ...
   */
  #define SQUARE_WAVE_STEPPING  //GA3Dtech

  /**
   * Enable M122 debugging command for TMC stepper drivers.
   * M122 S0/1 will enable continuous reporting.
   */
  #define TMC_DEBUG  //GA3Dtech
